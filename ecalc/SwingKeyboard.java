...
/**
 * a swing GUI keyboard
 */
public class SwingKeyboard extends JFrame
        implements KeyListener,
		   ActionListener
{
	//======================================================================
	// Machine will be a daemon, Screen and Keyboard attach and detach from
	// it. How they pass message?
	//
	// TODO I cann't extends both JFrame and Screen.
	...
	private static void createAndShowGUI() {
		...
		SwingKeyboard frame = new SwingKeyboard("SwingKeyboard");
	...
	public SwingKeyboard(String name) {
		super(name);
	}
